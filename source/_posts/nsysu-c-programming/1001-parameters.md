...
**實驗課題型加練**
以下三題的**題型**取自去年（2025）第 4 週實驗課的課堂練習（今年這週的投影片還沒出，題目可能會換）：同一個 swap 寫傳值版與傳參考版、預設引數、還有一題「反轉相加到迴文」的經典題。題目不是我原創的——練的東西跟去年那幾題一樣，但敘述、規則細節、範例資料和解答都是我自己重寫的，不是原題。Q9 是我自己出的補充題，Q10 配合課本勾選題。
