...
- **五份模擬考**：期中與期末各兩份模擬上機考（一份照主課題型、一份照實驗課考古題型），加上期末筆試模擬題，都附解答
...
課本是 *Absolute C++*, Walter Savitch, 6/e（Global Edition）。主課成績是**期中上機 30% ＋ 期末筆試 30% ＋ 期末上機 40%**（沒有作業分數、不點名，但考試沒到就是 0 分），而期末上機比期中進步 30 分以上還可以加 1–3 分——換句話說，**期中考砸了不是世界末日**。老師第一堂課講明：**期中考幾乎全部從下表「課本指定習題」那些題目出，期末約六成**，題號照第 6 版課本——所以那幾題一定要自己寫過。實驗課另外算分：課堂實作 60%（每週做完當場檢查）＋ 期末考 40%。
...
| **[11/05｜期中上機考（範圍 Ch 1–6）](/2026/09/09/nsysu-c-programming/1105-midterm/)** | 複習清單＋兩份 90 分鐘模擬上機考：主課題型、實驗課考古題型（附解答） | Ch7: 1, 5, 6, 8, 11 |
...
| **[12/24｜期末上機考（範圍 Ch 1–12、Ch 14）](/2026/09/09/nsysu-c-programming/1224-final-lab/)** | 應考流程＋兩份 120 分鐘模擬上機考：主課多檔案題型、實驗課考古題型（附解答） | — |
