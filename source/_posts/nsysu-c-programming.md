...
> **關於這份筆記**
> 本文依據國立中山大學資工系 CSE123「C 程式設計」（授課老師：柯正雯 副教授）與其對應實驗課 1151 學期的**公開進度表**寫成。內容皆為筆者針對每一週語法重點所整理的**原創說明、自寫範例與自出練習題**，並不轉載教科書 *Absolute C++* (Walter Savitch, 6/e) 內文、圖片、習題題目或授課教授自製投影片。練習題的**題型**參考了歷年實驗課的課堂練習與上機考（題目敘述、範例資料與解答皆為重新撰寫），讓你練的東西跟課堂檢查會遇到的一致。若讀者希望取得完整原文與課本習題，仍請透過正版管道取得該書。
>
...
- **每週一篇**：觀念講解 ＋ 可以直接複製編譯的範例 ＋ 常見雷區 ＋ 練習題與參考解答。每篇練習題分兩段：前半是配合講解出的基本題，後半「實驗課題型加練」照歷年實驗課課堂練習與上機考的題型出（題目每年會換、題型很固定）
